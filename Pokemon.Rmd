  ...
  layout(sliders = list(list(active = 100,
        ...
        updatemenus = list(
          list(
            buttons = list(
              list(method = 'restyle',
                   args = list(pokes$Name == "Cacturne", list(pokes$Name =='Cacturne')),
                   label = "Cacturne"),
              list(method = 'restyle',
                   args = list(pokes$Name == "Bagon", list(pokes$Name =='Bagon')),
                   label = "Bagon"),
              list(method = 'restyle',
                   args = list(pokes$Name == 'Sableye', list(pokes$Name =='virginica')),
                   label = "Sableye")
              ))))
